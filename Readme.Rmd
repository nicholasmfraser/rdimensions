...
For interacting with the Dimensions Analytics API, `rdimensions` currently supports a single function, `dimensions_raw`. This function takes two arguments: `query` and `format`:
